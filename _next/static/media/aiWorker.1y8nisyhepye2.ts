...
if (
  ...
  // Web: ORT-web's WASM backend only multi-threads when the page is
  // crossOriginIsolated (SharedArrayBuffer available) — see
  // mememaker-web-performance-design.md's Phase 2 C1. Same cap as desktop,
  // for the same overheat reason (R3 in desktop-inference-lessons.md).
  capWasmThreads(env);
}
