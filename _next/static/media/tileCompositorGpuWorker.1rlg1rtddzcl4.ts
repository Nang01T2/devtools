...
import {
  ...
  GPU_BLEND_MODE_ID,
  demoteBlendMode,
} from "@gadgetforge/render-core/blendModes";
...
// vs. a CPU monolithic cache raster at a DIFFERENT mip level; `tools/gpu-
// parity`'s "colorLookup3d" section, added by mememaker-gpu-adjustment-
// lut-webgpu-port F03, measured a ±3 LSB maximum live on the WebGPU tier
// (shipped with a ±4 ceiling, one level of headroom) that already accounts
// for interpolation error — this WebGL2 path was not independently
// re-measured, but a dither-phase mismatch is bounded
// by the same +/-4-level Bayer strength either way).
